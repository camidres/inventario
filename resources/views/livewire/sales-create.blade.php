<div>
    ...
    <div class="container  flex flex-col  w-full  py-14   lg:pl-64  ">
        ...
        <div class="container block py-6 items-center  bg-white rounded-md shadow-md mb-8  md:flex ">


            <div class="w-full" wire:ignore>
                <select class="select2 w-full" wire:model="product">
            ...
            <x-input type="number" class="mt-4 w-full md:ml-4 md:mt-0" placeholder="Precio del producto"
                wire:model="price" />

            <x-input type="number" class="mt-4 w-full md:ml-4 md:mt-0" placeholder="Cantidad" wire:model="qty" />

            <div class=" flex w-full justify-center mt-4 md:ml-4 md:mt-0 ">
